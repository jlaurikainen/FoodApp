      ...
      <form>
        ...
        <div class="row">
          <div class="column">
            ...
            <input type="number" name="height" class="u-full-width" v-model="userInfo.height">
          </div>
          <div class="column">
            <label for="mealCarbs">Paino</label>
            <input type="number" name="weight" class="u-full-width" v-model="userInfo.weight">
          </div>
        </div>
        <div class="row">
          <div class="column">
            <label for="mealProtein">Ikä</label>
            <input type="number" name="age" class="u-full-width" v-model="userInfo.age">
          </div>
        </div>
        <div class="row">
          <div class="column one-half">
            <label>
              <input type="radio" name="sex" value="female" v-model="userInfo.sex"><span class="label-body">Nainen</span>
            </label>
          </div>
          <div class="column one-half">
            <label>
              <input type="radio" name="sex" value="male" v-model="userInfo.sex"><span class="label-body">Mies</span>
            </label>
          </div>
        </div>
        <div class="row">
